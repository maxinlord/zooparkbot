...
async def rk_main_menu():
    ...
    builder.button(text=await get_text_button("bank"))
...
async def rk_zoomarket_menu():
    ...
    builder.button(text=await get_text_button("aviaries"))
...
async def rk_unity_menu():
    builder = ReplyKeyboardBuilder()
    builder.button(text=await get_text_button("level"))
    builder.button(text=await get_text_button("unity_members"))
    builder.button(text=await get_text_button("top_unity"))
    builder.button(text=await get_text_button("exit_from_unity"))    
    builder.button(text=await get_text_button("back"))
